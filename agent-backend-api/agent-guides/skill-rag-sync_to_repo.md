...
## 请求定义
- Method: POST
- Path: /v1/skills/rag.sync_to_repo:invoke
- Headers:
  - Content-Type: application/json
  - Accept: application/json
- Body:
  {
    "input": {"repo":"HIT-A/HITA_RagData","branch":"main","daily":false}
  }

## ReAct 模板
- Thought: 我需要 rag.sync_to_repo 来完成当前子任务。
- Action: 调用 /v1/skills/rag.sync_to_repo:invoke 并传入最小参数。
