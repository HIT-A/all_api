...
## 请求定义
- Method: POST
- Path: /v1/skills/crawl4ai.site:invoke
- Headers:
  - Content-Type: application/json
  - Accept: application/json
- Body:
  {
    "input": {"start_url":"https://example.com","max_pages":20}
  }

## ReAct 模板
- Thought: 我需要 crawl4ai.site 来完成当前子任务。
- Action: 调用 /v1/skills/crawl4ai.site:invoke 并传入最小参数。
