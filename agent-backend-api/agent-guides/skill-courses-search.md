...
## 适用场景
课程搜索，支持 teachers/aliases 语义。

## 请求定义
- Method: POST
- Path: /v1/skills/courses.search:invoke
- Headers:
  - Content-Type: application/json
  - Accept: application/json
- Body:
  {
    "input": {"keyword":"python","campus":"shenzhen"}
  }

## ReAct 模板
- Thought: 我需要 courses.search 来完成当前子任务。
- Action: 调用 /v1/skills/courses.search:invoke 并传入最小参数。
