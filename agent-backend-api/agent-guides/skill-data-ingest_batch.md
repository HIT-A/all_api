...
## 请求定义
- Method: POST
- Path: /v1/skills/data.ingest_batch:invoke
- Headers:
  - Content-Type: application/json
  - Accept: application/json
- Body:
  {
    "input": {"items":[{"source_type":"manual","source_name":"A","content":"# A"}]}
  }

## ReAct 模板
- Thought: 我需要 data.ingest_batch 来完成当前子任务。
- Action: 调用 /v1/skills/data.ingest_batch:invoke 并传入最小参数。
