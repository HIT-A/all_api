...
## 请求定义
- Method: POST
- Path: /v1/skills/rag.ingest_from_github:invoke
- Headers:
  - Content-Type: application/json
  - Accept: application/json
- Body:
  {
    "input": {"repos":[{"org":"HIT-A","repo":"all_api","ref":"main"}]}
  }

## ReAct 模板
- Thought: 我需要 rag.ingest_from_github 来完成当前子任务。
- Action: 调用 /v1/skills/rag.ingest_from_github:invoke 并传入最小参数。
