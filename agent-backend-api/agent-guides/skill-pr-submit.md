...
## 适用场景
提交 PR。深圳支持 multi-project ops。

## 请求定义
- Method: POST
- Path: /v1/skills/pr.submit:invoke
- Headers:
  - Content-Type: application/json
  - Accept: application/json
- Body:
  {
    "input": {"campus":"harbin","course_code":"CS101","ops":[{"op":"add_section_item","title":"更新","content":"内容"}],"idempotency_key":"submit-20260318"}
  }

## ReAct 模板
- Thought: 我需要 pr.submit 来完成当前子任务。
- Action: 调用 /v1/skills/pr.submit:invoke 并传入最小参数。
