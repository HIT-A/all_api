...
## 请求定义
- Method: POST
- Path: /v1/skills/cos.save_file:invoke
- Headers:
  - Content-Type: application/json
  - Accept: application/json
- Body:
  {
    "input": {"key":"tmp/hello.txt","content_base64":"aGVsbG8="}
  }

## ReAct 模板
- Thought: 我需要 cos.save_file 来完成当前子任务。
- Action: 调用 /v1/skills/cos.save_file:invoke 并传入最小参数。
