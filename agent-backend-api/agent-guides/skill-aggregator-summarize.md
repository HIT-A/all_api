...
## 请求定义
- Method: POST
- Path: /v1/skills/aggregator.summarize:invoke
- Headers:
  - Content-Type: application/json
  - Accept: application/json
- Body:
  {
    "input": {"query":"机器学习","results":[{"title":"A","content":"B"}]}
  }

## ReAct 模板
- Thought: 我需要 aggregator.summarize 来完成当前子任务。
- Action: 调用 /v1/skills/aggregator.summarize:invoke 并传入最小参数。
