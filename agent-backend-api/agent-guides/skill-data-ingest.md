...
## 请求定义
- Method: POST
- Path: /v1/skills/data.ingest:invoke
- Headers:
  - Content-Type: application/json
  - Accept: application/json
- Body:
  {
    "input": {"source_type":"manual","source_name":"分享","content":"# 内容"}
  }

## ReAct 模板
- Thought: 我需要 data.ingest 来完成当前子任务。
- Action: 调用 /v1/skills/data.ingest:invoke 并传入最小参数。
