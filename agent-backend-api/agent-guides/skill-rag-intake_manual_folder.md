# skill: rag.intake_manual_folder
...
## 请求定义
- Method: POST
- Path: /v1/skills/rag.intake_manual_folder:invoke
- Headers:
  - Content-Type: application/json
  - Accept: application/json
- Body:
  {
    "input": {"repo":"HIT-A/HITA_RagData","branch":"main","folder":"manual"}
  }

## ReAct 模板
- Thought: 我需要 rag.intake_manual_folder 来完成当前子任务。
- Action: 调用 /v1/skills/rag.intake_manual_folder:invoke 并传入最小参数。
