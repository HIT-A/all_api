...
## 请求定义
- Method: POST
- Path: /v1/skills/files.download:invoke
- Headers:
  - Content-Type: application/json
  - Accept: application/json
- Body:
  {
    "input": {"key":"tmp/a.txt","format":"url"}
  }

## ReAct 模板
- Thought: 我需要 files.download 来完成当前子任务。
- Action: 调用 /v1/skills/files.download:invoke 并传入最小参数。
